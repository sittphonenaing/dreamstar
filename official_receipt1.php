...
<a href="" id="printpagebutton" onclick="myFunction()"><B>Print</B></a>
		...
		<h3 class="one"><img src="img/dreamstar.gif" width="356" height="101"  /><br/>Official Receipt<br /><font color="red"><U>UNPAID</U></font></h3>
		<div class="printtitle">
			<hr>
<b> The company is located at Shan Kone St San Chang Tsp,  <Br>
Yangon, Myanmar (Burma)</b><hr></div>
		...
		<table border="" color="black">
			...
			$row4=mysql_fetch_array($query4);
				...
				echo '<td><div align="center">$ '.formatMoney($row4['price'],2).'</div></td>';
				echo '<td><div align="center">'.$row3['Quantity'].'</div></td>';
				echo '<td><div align="center">$ '.formatMoney($row3['Total'],2).'</div></td></tr>';
            ...
            <td >$ 150.00</td>
            <td ><?php echo 'P$ '.formatMoney($tax,2); ?></td>
            </tr>
            <tr>
